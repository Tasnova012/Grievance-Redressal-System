<?php
    include 'header.php';
    include 'process/edit/edit-dept.php';
    ...
    if(isset($_GET['id']) && $_GET['id']!=''){
        ...
        $get_user_info = mysqli_query($con,"SELECT * FROM department WHERE id='$id'");
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <button name="edit-staff" class="btn btn-primary mt-2" type="submit">Update Department</button>
