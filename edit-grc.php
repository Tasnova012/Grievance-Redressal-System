<?php
    include 'header.php';
    include 'process/edit/edit-grc.php';
    ...
    if(isset($_GET['id']) && $_GET['id']!=''){
        ...
        $get_user_info = mysqli_query($con,"SELECT * FROM grc WHERE id='$id'");
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <button name="edit-staff" class="btn btn-primary mt-2" type="submit">Update GRC</button>
