<?php
    include 'header.php';
    include 'process/new/new-grc.php';
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                            <li class="nav-item">
                                                <a class="nav-link fw-bold p-3 active" href="#">Add New GRC</a>
                                            </li>
                                        </ul>                                              
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                                            ...
                                            <button name="new-staff" class="btn btn-primary mt-2" type="submit">Add New GRC</button>
