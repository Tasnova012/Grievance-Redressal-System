<?php
    include 'header.php';
    include 'process/new/new-proctor.php';
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                            <li class="nav-item">
                                                <a class="nav-link fw-bold p-3 active" href="#">Add New Proctor</a>
                                            </li>
                                        </ul>                                              
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Select GRC</label>
                                                        <select name="grc" id="inputState" class="form-control" tabindex="-98">
                                                            <?php
                                                                $query = "SELECT * FROM grc";
                                                        ...
                                                        <small style="color:red"><?php echo $bbgrcError; ?></small>                                                               
                                                    </div>
                                                </div>                                                 
                                                <div class="col-md-12">
                                                    <div class="mb-3 mt-3">
                                            ...
                                            <button name="new-staff" class="btn btn-primary mt-2" type="submit">Add New Proctor</button>
