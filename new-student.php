<?php
    include 'header.php';
    include 'process/new/new-student.php';
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <small style="color:red"><?php echo $bbstudent_idError; ?></small>                                                                
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                            ...
                                            <button name="new-student" class="btn btn-primary mt-2" type="submit">Add New Student</button>
