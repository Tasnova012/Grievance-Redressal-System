<?php
    include 'header.php';
    include 'process/edit/edit-student.php';
    ...
    if(isset($_GET['id']) && $_GET['id']!=''){
        ...
        $get_user_info = mysqli_query($con,"SELECT * FROM students WHERE id='$id'");
                                ...
                                <div class="card">
                                    <div class="card-body  pt-0">
                                        <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                            <li class="nav-item">
                                                <a class="nav-link fw-bold p-3 active" href="#">Add New Student</a>
                                            </li>
                                        </ul>                                              
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input readonly value="<?php echo $dbemail ?>" name="email" type="text" class="form-control" placeholder="Email Address">  
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input readonly value="<?php echo $dbstudent_id ?>" name="student_id" type="text" class="form-control" placeholder="Student ID"> 
                                                        <small style="color:red"><?php echo $student_idError; ?></small>                                                                
                                                    </div>
                                                </div>                                                                                      
                                            </div>       
                                            <button name="update-student" class="btn btn-primary mt-2" type="submit">Update Student</button>
